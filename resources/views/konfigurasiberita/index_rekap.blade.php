                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <form action="/konfigberita/konfigrekapberita" method="get"
                                        ...
                                        @foreach($konfig as $id=>$dt)
                                           ...
                                           margin: 0 auto; overflow-x: auto; white-space: nowrap;">
                                                    <div class="btn-group">
                                                        ...
                                                        <form action="/konfigberita/{{ $dt->id_konfig }}/deletekonfig_rekap"
                                                              method="post"
        ...
        <div class="modal-dialog modal-dialog-centered" style="width: 1000px;" role="document">
            <div class="modal-content" style="">
                ...
                <div class="modal-body " style="">
                    <form action="/konfigberita/storekonfig_rekap" method="post" id="frmBeritaSatkerKonfigRekap"
    ...
    <script>
        $(function () {
            ...
            $('.tampilkandetailkonfig_rekap').click(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/konfigberita/tampilkandetailkonfig_rekap',
                    cache: false,
                    data: {
                        _token: "{{ csrf_token() }}",
                        id_konfig: id_konfig,
            ...
            $('.editkonfig_rekap').click(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/konfigberita/editkonfig_rekap',
                    cache: false,
                    data: {
                        _token: "{{ csrf_token() }}",
