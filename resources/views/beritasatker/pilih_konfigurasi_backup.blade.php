...
<div class="row" id="id_berita" name="id_berita" id_berita="">
    ...
    <div class="row mt-2">
        <div class="col-12">
            <div class="form-group">
                <a class="tampilkanlaporan_whatssap_message_today btn btn-primary w-100"
                   kode_satker_value="{{ $kode_satker_value }}">
                    ...
                    Download (.docx) Laporan Whatssap
                </a>
            </div>
        </div>
    </div>
...
<div class="modal modal-blur fade" id="modal-tampilkandetail_whatssap_message_today" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="loadedittampilkandetail_whatssap_message_today">
...
<script>
    $(function () {
        $('.tampilkanlaporan_whatssap_message_today').click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: '/datasatker/whatssapgenerate_message_today',
                cache: false,
                data: {
                    _token: "{{ csrf_token() }}",
                    id_konfig: id_konfig,
                ...
                success: function(respond){
                    console.log(respond);
                    //$('#loadedittampilkandetail_whatssap_message_today').html(respond);
                }
            });

            //$('#modal-tampilkandetail_whatssap_message_today').modal('show');
            $('#pilih_konfigurasi_modal').modal('hide');
        });
    });
</script>
